...
class Downloader:
  ...
  def download(self, sector=None, symbols=None, period='1y', open_filename=None):
    ...
    if sector is not None:
      ...
      if symbols is not None:
        ...
        filename  = 'data/'+period+'_'+now_str+'_'+(hashlib.sha224((''.join(self.symbols)).encode('utf-8')).hexdigest())+".pkl"
      else:
        filename  = 'data/'+period+'_'+now_str+'_'+(hashlib.sha224(('all').encode('utf-8')).hexdigest())+".pkl"
